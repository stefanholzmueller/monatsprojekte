...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["", "canada.dart", , Z, {
  "^": "",
  main: [function() {
    $.get$analyser().fftSize = 2048;
    var t1 = J.get$onLoad$x($.get$canadaImg());
  ...
  update: [function(n) {
    var t1, dataArray, maximum, t2, t3, t4;
    t1 = $.get$analyser().frequencyBinCount;
    if (typeof t1 !== "number" || Math.floor(t1) !== t1)
      H.throwExpression(P.ArgumentError$("Invalid length " + H.S(t1)));
    dataArray = new Uint8Array(t1);
    $.get$analyser().getByteTimeDomainData(dataArray);
    maximum = C.NativeUint8List_methods.reduce$1(dataArray, P.max$closure());
    if (typeof maximum !== "number")
      return maximum.$div();
    J.set$width$x($.get$canvas(), J.get$width$x($.get$canadaImg()));
    J.set$height$x($.get$canvas(), J.get$height$x($.get$canadaImg()));
    $.get$canvasCtx().drawImage($.get$canadaImg(), 0, 0);
    t1 = $.get$canvasCtx();
    t2 = J.get$width$x($.get$headImg());
    if (typeof t2 !== "number")
      return H.iae(t2);
    t3 = J.get$height$x($.get$headImg());
    if (typeof t3 !== "number")
      return H.iae(t3);
    t1.translate(240 + t2, 45 + t3);
    $.get$canvasCtx().rotate((maximum / 128 - 1) * 30 * 3.141592653589793 / 180);
    t3 = $.get$canvasCtx();
    t2 = $.get$headImg();
    t1 = J.get$width$x(t2);
    if (typeof t1 !== "number")
      return t1.$negate();
    t4 = J.get$height$x($.get$headImg());
    if (typeof t4 !== "number")
      return t4.$negate();
    t3.drawImage(t2, -t1, -t4);
    $.get$canvasCtx().restore();
    C.Window_methods.get$animationFrame(window).then$1(Z.update$closure());
  }, "call$1", "update$closure", 2, 0, 1],
  main_closure: {
    "^": "Closure:10;",
    call$1: function(_) {
      var t1 = J.get$onLoad$x($.get$headImg());
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Z.main__closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }
  },
  main__closure: {
    "^": "Closure:10;",
    call$1: function(_) {
      J.getUserMedia$2$audio$video$x(window.navigator, true, false).then$1(new Z.main___closure());
    }
  },
  main___closure: {
    "^": "Closure:10;",
    call$1: function(stream) {
      $.get$audioCtx().createMediaStreamSource(stream).connect($.get$analyser(), 0, 0);
      C.Window_methods.get$animationFrame(window).then$1(Z.update$closure());
    }
  }
},
...
["dart.collection", "dart:collection", , P, {
  ...
  ListMixin: {
    ...
    reduce$1: function(receiver, combine) {
      ...
      value = receiver[0];
      for (t2 = $length !== t1, i = 1; i < $length; ++i) {
        if (i >= t1)
          return H.ioore(receiver, i);
...
Isolate.$lazy($, "canvasCtx", "canvasCtx", "get$canvasCtx", function() {
  return J.get$context2D$x($.get$canvas());
});
Isolate.$lazy($, "canadaImg", "canadaImg", "get$canadaImg", function() {
  return W.ImageElement_ImageElement(null, "canada.png", null);
});
Isolate.$lazy($, "headImg", "headImg", "get$headImg", function() {
  return W.ImageElement_ImageElement(null, "head.png", null);
});
Isolate.$lazy($, "audioCtx", "audioCtx", "get$audioCtx", function() {
  return new (window.AudioContext || window.webkitAudioContext)();
});
Isolate.$lazy($, "analyser", "analyser", "get$analyser", function() {
  return $.get$audioCtx().createAnalyser();
});
...
//# sourceMappingURL=canada.dart.js.map
